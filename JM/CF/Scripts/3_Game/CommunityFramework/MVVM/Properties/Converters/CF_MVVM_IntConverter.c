class CF_MVVM_IntConverter
{
	static bool Get(CF_Model_Base model, string variable, out int value)
	{
		CF_Trace trace(null, "CF_MVVM_IntConverter::Get", "" + model, variable);
	...
	static bool Set(CF_Model_Base model, string variable, int value)
	{
		CF_Trace trace(null, "CF_MVVM_IntConverter::Set", "" + model, variable, "" + value);
