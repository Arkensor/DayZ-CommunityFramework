class CF_MVVM_FloatConverter
{
	static bool Get(CF_Model_Base model, string variable, out float value)
	{
		CF_Trace trace(null, "CF_MVVM_FloatConverter::Get", "" + model, variable);
	...
	static bool Set(CF_Model_Base model, string variable, float value)
	{
		CF_Trace trace(null, "CF_MVVM_FloatConverter::Set", "" + model, variable, "" + value);
