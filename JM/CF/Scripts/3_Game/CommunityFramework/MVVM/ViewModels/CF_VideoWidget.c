...
class CF_VideoWidget : CF_Widget
{
	...
	{
		#ifdef CF_TRACE_ENABLED
		auto trace = CF_Trace_2(this, "OnView_Path").Add(sender).Add(args.GetDebugName());
		#endif
	...
	{
		#ifdef CF_TRACE_ENABLED
		auto trace = CF_Trace_2(this, "OnModel_Path").Add(sender).Add(args.GetDebugName());
		#endif
	...
	{
		#ifdef CF_TRACE_ENABLED
		auto trace = CF_Trace_2(this, "OnView_Command").Add(sender).Add(args.GetDebugName());
		#endif
	...
	{
		#ifdef CF_TRACE_ENABLED
		auto trace = CF_Trace_2(this, "OnModel_Command").Add(sender).Add(args.GetDebugName());
		#endif
	...
	{
		#ifdef CF_TRACE_ENABLED
		auto trace = CF_Trace_2(this, "OnView_Subtitles").Add(sender).Add(args.GetDebugName());
		#endif
	...
	{
		#ifdef CF_TRACE_ENABLED
		auto trace = CF_Trace_2(this, "OnModel_Subtitles").Add(sender).Add(args.GetDebugName());
		#endif
