...
class CF_MVVM_Linker
{
	...
	void _ViewChanged(string name, CF_MVVM_Property srcProperty, CF_EventArgs args)
	{
		...
		auto trace = CF_Trace_3(this, "_ViewChanged").Add(name).Add(srcProperty).Add(args.ToStr());
		#endif
	...
	{
		#ifdef CF_TRACE_ENABLED
		auto trace = CF_Trace_1(this, "_ViewChanged").Add(args.ToStr());
		#endif
	...
	{
		#ifdef CF_TRACE_ENABLED
		auto trace = CF_Trace_2(this, "NotifyPropertyChanged").Add(name).Add(args.ToStr());
		#endif
	...
	{
		#ifdef CF_TRACE_ENABLED
		auto trace = CF_Trace_1(this, "NotifyPropertyChanged").Add(args.ToStr());
		#endif
