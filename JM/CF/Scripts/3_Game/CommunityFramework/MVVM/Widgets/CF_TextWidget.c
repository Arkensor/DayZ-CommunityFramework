class CF_TextWidget : CF_Widget
{
	...
	void OnView_TextSpacingHorizontal(CF_ModelBase model, CF_Event evt)
	{
		EnScript.SetClassVar(model, TextSpacingHorizontal, 0, _TextSpacingHorizontal);
	}

	void OnModel_TextSpacingHorizontal(CF_ModelBase model, CF_Event evt)
	{
	...
	void OnView_TextOutlineColor(CF_ModelBase model, CF_Event evt)
	{
		float _value = _TextWidget.GetOutlineColor();
		EnScript.SetClassVar(model, TextOutlineColor, 0, _value);
	}

	void OnModel_TextOutlineColor(CF_ModelBase model, CF_Event evt)
	{
		float _value;
	...
	void OnView_TextShadowSize(CF_ModelBase model, CF_Event evt)
	{
		float _value = _TextWidget.GetShadowSize();
		EnScript.SetClassVar(model, TextShadowSize, 0, _value);
	}

	void OnModel_TextShadowSize(CF_ModelBase model, CF_Event evt)
	{
		float _sx, _sy;
	...
	void OnView_TextShadowColor(CF_ModelBase model, CF_Event evt)
	{
		float _value = _TextWidget.GetShadowColor();
		EnScript.SetClassVar(model, TextShadowColor, 0, _value);
	}

	void OnModel_TextShadowColor(CF_ModelBase model, CF_Event evt)
	{
		float _sx, _sy;
		_TextWidget.GetShadowOffset(_sx, _sy);
	...
	void OnView_TextShadowOpacity(CF_ModelBase model, CF_Event evt)
	{
		float _value = _TextWidget.GetShadowOpacity();
		EnScript.SetClassVar(model, TextShadowOpacity, 0, _value);
	}

	void OnModel_TextShadowOpacity(CF_ModelBase model, CF_Event evt)
	{
		float _sx, _sy;
		_TextWidget.GetShadowOffset(_sx, _sy);
	...
	void OnView_TextShadowOffsetX(CF_ModelBase model, CF_Event evt)
	{
		float _value, _other;
	...
	void OnModel_TextShadowOffsetX(CF_ModelBase model, CF_Event evt)
	{
		float _sx, _sy;
		_TextWidget.GetShadowOffset(_sx, _sy);
	...
	void OnView_TextShadowOffsetY(CF_ModelBase model, CF_Event evt)
	{
		float _value, _other;
	...
	void OnModel_TextShadowOffsetY(CF_ModelBase model, CF_Event evt)
	{
		float _sx, _sy;
		_TextWidget.GetShadowOffset(_sx, _sy);
	...
	void OnView_TextItalic(CF_ModelBase model, CF_Event evt)
	{
		bool _value = _TextWidget.GetItalic();
		EnScript.SetClassVar(model, TextItalic, 0, _value);
	}

	void OnModel_TextItalic(CF_ModelBase model, CF_Event evt)
	{
		bool _value;
	...
	void OnView_TextBold(CF_ModelBase model, CF_Event evt)
	{
		bool _value = _TextWidget.GetBold();
		EnScript.SetClassVar(model, TextBold, 0, _value);
	}

	void OnModel_TextBold(CF_ModelBase model, CF_Event evt)
	{
		bool _value;
	...
	void OnView_TextSizeX(CF_ModelBase model, CF_Event evt)
	{
		int _value, _other;
	...
	void OnModel_TextSizeX(CF_ModelBase model, CF_Event evt)
	{
		OnView_TextSizeX(model, evt);
	}

	void OnView_TextSizeY(CF_ModelBase model, CF_Event evt)
	{
		int _value, _other;
	...
	void OnModel_TextSizeY(CF_ModelBase model, CF_Event evt)
	{
		OnView_TextSizeY(model, evt);
	}

	void OnView_TextProportion(CF_ModelBase model, CF_Event evt)
	{
		bool _value = _TextWidget.GetTextProportion();
		EnScript.SetClassVar(model, TextProportion, 0, _value);
	}

	void OnModel_TextProportion(CF_ModelBase model, CF_Event evt)
	{
		bool _value;
